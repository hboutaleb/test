...
public class MailSender {
    ...
    public static void sendMailWithAttachedFile(Session session, String from,
            ...
            String fileName1,String fileName2,  byte[] fileData1,byte[] fileData2, String fileMimeType)
        ...
        // création d'un nouvel objet MimeBodyPart qui contient le 1er fichier attaché     
        MimeBodyPart messageBodyPart2 = new MimeBodyPart();
        DataSource source = new ByteArrayDataSource(fileData1, fileMimeType);
        messageBodyPart2.setDataHandler(new DataHandler(source));
        messageBodyPart2.setFileName(fileName1);
        
                // création d'un nouvel objet MimeBodyPart qui contient le 2nd fichier attaché     
                MimeBodyPart messageBodyPart3 = new MimeBodyPart();
        source = new ByteArrayDataSource(fileData2, fileMimeType);
